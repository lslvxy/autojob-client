...
import com.laysan.autojob.client.constants.EventTypeEnums;
import com.laysan.autojob.client.dto.AccountDTO;
import com.laysan.autojob.client.entity.Account;
import com.laysan.autojob.client.entity.Event;
import com.laysan.autojob.client.repository.AccountRepository;
import com.laysan.autojob.client.repository.EventRepository;
import com.laysan.autojob.client.service.AccountService;
...
public class AccountController extends BaseController {
    ...
    public Response save(@RequestBody Account account, HttpServletRequest request) throws Exception {
        ...
        if (ObjectUtil.isNotNull(account.getId())) {
            ...
            event.setEventType(EventTypeEnums.UPDATE_JOB.name());
            ...
            event.setUserId(userId);
            event.setAccountId(account.getId());
            event.setEventType(EventTypeEnums.CREATE_JOB.name());
            eventRepository.save(event);
        }
